...
O sistema valida se o somatório da grade é igual à quantidade total informada (RN010).
O usuário define modelo, material e cor das tiras.
O usuário seleciona a arte no catálogo ou escolhe a opção de arte exclusiva com local para anexar o arquivo correspondente.
...
O sistema calcula o consumo de tinta sublimática, considerando os pares e as embalagens sublimadas do pedido (RN008).
O sistema calcula a quantidade de tags e travas anel, considerando os pares e as necessaires do pedido (RN009).
...
O usuário seleciona o pedido e consulta a ficha de produção correspondente (RF017).
